...
<html lang="en">
  <head>
	...
	<section class="ftco-section">
		<form method="post" action="<?php echo e(route('auth.login')); ?>" class="box">
			<?php echo csrf_field(); ?>
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Chào mừng bạn đến với Quiz 2022</h2>
				</div>
			</div>
			<div class="row justify-content-center">
	          ...
	          <p class="w-100 text-center">&mdash; Hoăc đăng nhập bằng &mdash;</p>
...
<?php /**PATH /var/www/html/MD5/Dự án/quiz2022-backend/project-quizz/resources/views/auth/login.blade.php ENDPATH**/ ?>